...
describe Coupler::Transformers::Parameter do
  it "should have a name" do
    p = Coupler::Transformers::Parameter.new('name' => 'x')
    p.name.should == 'x'
  end

  it "should have a coerce_to value" do
    p = Coupler::Transformers::Parameter.new('name' => 'x', 'coerce_to' => 'integer')
    p.coerce_to.should == 'integer'
  end

  it "should have a regexp" do
    p = Coupler::Transformers::Parameter.new({
      'name' => 'x',
      'coerce_to' => 'integer',
      'regexp' => '\d+'
    })
  ...
  describe "#convert" do
    ...
    it "should convert value to String if 'string'" do
      p = Coupler::Transformers::Parameter.new('name' => 'x', 'coerce_to' => 'string')
      p.convert(123).should == "123"
    end
